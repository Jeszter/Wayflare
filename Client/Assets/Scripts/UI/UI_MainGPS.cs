namespace DevelopersHub.ClashOfWhatecer
{
    ...
    public class UI_MainGPS : MonoBehaviour
    {
        ...
        private static UI_MainGPS _instance = null; public static UI_MainGPS instanse { get { return _instance; } }
        ...
        private void BattleButtonClicked()
        {
            ...
            UI_SearchBattle.instanse.SetStatus(true);
            SetStatus(false);
        }
